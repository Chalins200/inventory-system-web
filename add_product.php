...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','cod_bar','product-categorie','product-quantity','buying-price', 'saleing-price');
   validate_fields($req_fields);
   if(empty($errors)){
     $p_name  = remove_junk($db->escape($_POST['product-title']));
     $p_cod  = remove_junk($db->escape($_POST['cod_bar']));
     ...
     $query .=" cod_bar,name,quantity,buy_price,sale_price,categorie_id,media_id,date";
     $query .=") VALUES (";
     $query .=" '{$p_cod}','{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}'";
     $query .=")";
          ...
          <form method="post" action="add_product.php" class="clearfix">
              ...
              <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="cod_bar" placeholder="Código de barras">
                   </div>
              </div>
              <div class="form-group">
                <div class="row">
